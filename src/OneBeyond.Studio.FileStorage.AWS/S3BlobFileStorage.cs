...
public class S3BlobFileStorage : FileStorageBase
{
    ...
    protected readonly S3BlobFileStorageOptions _fileStorageOptions;

    public S3BlobFileStorage(
        MimeTypeValidationOptions mimeTypeValidationOptions,
        S3BlobFileStorageOptions fileStorageOptions)
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new S3StorageException("Unable to generate a file url, SharedAccessDurationis not set.");
        }
